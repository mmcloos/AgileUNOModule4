...
for play in range(10):
    ...
    while not solved:
        ...
        if guess == number:
            ...
            print(
                f"great job {myData['first_name']}, your guess of {guess} is correct")
        ...
        if solved:
            print(
                f"Let's play again, you have completed {wins} out of 10 plays.")
...
print(
    f"It took {myData['first_name']} {myData['last_name']} {guesses} guesses to do this.")
# exit the game
exit()
[DEBUG ON]
>>> 
